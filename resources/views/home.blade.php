            ...
            <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                <div class="relative pt-36 ml-auto">
                    <div class="lg:w-2/3 text-center mx-auto">
                        <h1 class="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">Shaping a world with
                            <span class="text-primary dark:text-white">reimagination.</span>
                        </h1>
                        <p class="mt-8 text-gray-700 dark:text-gray-300">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Odio incidunt nam itaque sed eius modi error totam sit illum. Voluptas doloribus asperiores quaerat
                            aperiam. Quidem harum omnis beatae ipsum soluta!</p>
                    ...
                    <div class="mt-12 grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6">
                        <div class="p-4 grayscale transition duration-200 hover:grayscale-0">
                            <img src="./images/clients/microsoft.svg" class="h-12 w-auto mx-auto" loading="lazy" alt="client logo"
                                width="" height="">
                        </div>
                        <div class="p-4 grayscale transition duration-200 hover:grayscale-0">
                        ...
                        <div class="p-4 flex grayscale transition duration-200 hover:grayscale-0">
                            <img src="./images/clients/google.svg" class="h-9 w-auto m-auto" loading="lazy" alt="client logo" width=""
                                height="">
                        </div>
                        <div class="p-4 grayscale transition duration-200 hover:grayscale-0">
                            <img src="./images/clients/ge.svg" class="h-12 w-auto mx-auto" loading="lazy" alt="client logo" width=""
                                height="">
                        </div>
                        <div class="p-4 flex grayscale transition duration-200 hover:grayscale-0">
                        ...
                        <div class="p-4 grayscale transition duration-200 hover:grayscale-0">
                            <img src="./images/clients/google-cloud.svg" class="h-12 w-auto mx-auto" loading="lazy" alt="client logo"
                                width="" height="">
                        </div>
                    </div>
                </div>
            ...
            <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
                ...
                <div class="md:columns-2 lg:columns-3 gap-8 space-y-8">
                    <div
                        ...
                        <div class="flex gap-4">
                            <img class="w-12 h-12 rounded-full"
                                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRPazPZe4m9W3h_EzvlxqBm8z-9ftBO62p0gQ&s" alt="" width=""
                                height="" loading="lazy">
                            <div>
                    ...
                    <div
                        ...
                        <div class="flex gap-4">
                            <img class="w-12 h-12 rounded-full"
                                src="https://politics.princeton.edu/sites/default/files/styles/square/public/images/p-5.jpeg?h=87dbaab7&itok=ub6jAL5Q" alt="" width=""
                                height="" loading="lazy">
                            <div>
                    ...
                    <div
                        ...
                        <div class="flex gap-4">
                            <img class="w-12 h-12 rounded-full"
                                src="https://people.com/thmb/IfjWMKhodGNtpx11DvN1M0M3r1c=/4000x0/filters:no_upscale():max_bytes(150000):strip_icc():focal(349x0:351x2)/clarissa-cruz-headshot-people-f4197aa2a3b44efb90f907198d950c8d.jpg" alt="" width=""
                                height="" loading="lazy">
                            <div>
